...
public:
    ...
    // Move constructor
    ArrayQueue(ArrayQueue&& other) noexcept : _num_items(other._num_items), _allocated_size(other._allocated_size), _first(other._first), _last(other._last), _items(other._items) {
        other._num_items = 0;
        other._allocated_size = 1;
        other._first = 0;
        other._last = 0;
        other._items = new std::string[1];
    }
